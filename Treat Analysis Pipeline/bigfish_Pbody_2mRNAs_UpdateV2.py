...
manual = True # SET TO FALSE FIRST RUN, CHANGE THRESHOLDS IF NEEDED IN SPREADSHEET, SET TO TRUE AND RUN AGAIN
run_all = True # Must be true for automatic and can be true if manual but running all again
manual_threshold_path = r"\\10.67.15.232\lab\Morgane\MV500-501-502-503-504_25-09-03_MEFs WT Hsp110 Cy3 Dcp1a Cy5 rep3\Export\bigFISH_In\MEFs Hsp110 Rep3_manual detection4_250916.csv" # SET TO PATH TO SPREASHEET CREATED IN YOUR FOLDER
reference_threshold_path = r"\\10.67.15.232\lab\Morgane\MV500-501-502-503-504_25-09-03_MEFs WT Hsp110 Cy3 Dcp1a Cy5 rep3\Export\bigFISH_In\MEFs Hsp110 Rep3_manual detection3_250916.csv"# Need a reference path if running manual and not running all
##### ********** #######
...
headers = ['File Name', 'P-Body Threshold', "RNA1 Threshold", "RNA2 Threshold"]
result_file_name = "MEFs Hsp110 Dcp1a - Rep5_manual detection_250916.csv"
