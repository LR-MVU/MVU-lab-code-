...
Conds = newArray("CT/", "HS/", "2HR/", "3HR/", "4HR/", "6HR/", "8HR/", "10HR/", "12HR/", "24HR/")
	//"Ctl/", "HS/", "HS_2H_R/", "HS_3H_R/", "HS_4H_R/", "HS_6H_R/", "HS_8H_R/", "HS_10H_R/", "HS_12H_R/", "HS_24H_R/"');
...
for (j=0; j<Conds.length; j++){
	...
	for (i=5; i<Files740.length; i++){
		if (matches(Files740[i], ".*640S.*")){
			...
			//Save output
			saveAs("Results", od + "seeds_" + substring(Files740[i],0,lengthOf(Files740[i])-4) + ".csv");
			close("Results");
			close("*");
		}
	}
